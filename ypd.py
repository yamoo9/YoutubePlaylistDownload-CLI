...
# Sublime Text Playlist URL (기본 값)
ST_playlist_url = "https://www.youtube.com/playlist?list=PLAl17zBU4FvhcSVB6tYTSyv9EKUiFF2-1"


def get_playlist_links(playlist_url):
	page_elements = [x.decode('utf8') for x in urlopen(playlist_url).readlines()]
...
parser.add_argument('-p', '--playlisturl', help='url of the playlist to be downloaded', default=ST_playlist_url, metavar='')
